              ...
              <Link to={"/products"}>
                ...
                >
                  ...
                  {activeDropdown === "Products" && (
                    <div className="dropdown">
                      <h3 className="card-header">
                        <h3 style={{ fontWeight: 'bold', textAlign: 'center' , color:'black'}}>Our Products</h3><ul className="inner-ul">  <Link to={"/product-1"}>    <li>LMS(Learning Management System)</li>  </Link>  <Link to={"/product-2"}>    <li>ERS(Enterprise Resource Planning System)</li>  </Link>  <Link to={"/product-3"}>    <li>CRM(Customer Relationship Management)</li>  </Link>  <Link to={"/product-4"}>    <li>E-Commerce</li>  </Link></ul>
                      </h3>
                    </div>
                  )}
                </div>
