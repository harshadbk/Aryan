...
const data = [
  ...
  {
    img: Api,
    name: "Our customized software development services are designed to meet your specific business needs. We build tailored software solutions that enhance your operational efficiency, streamline processes, and provide a competitive edge. Whether it's a simple application or a complex system, our team delivers robust and scalable software that grows with your business.",
    review:
